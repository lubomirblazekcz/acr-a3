...
latency 			= 0.1;
tankTurnForce		= 450000; /// Random magic number, expected to be something like 11 x mass of vehicle
//600000;
...
class complexGearbox {
	GearboxRatios[]    = {"R2",-10.9,"N",0,"D1",4.7,"D2",3.5,"D3",2.6,"D4",2.0,"D5",1.92};
