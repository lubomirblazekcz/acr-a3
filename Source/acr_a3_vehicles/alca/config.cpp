...
class CfgVehicles
{
    ...
    class ACR_A3_L159_Alca_CAS: I_Plane_Fighter_03_CAS_F
    {
        ...
        hiddenSelectionsTextures[] = {"\acr_a3_vehicles\alca\data\l159_body_1_co.paa","\acr_a3_vehicles\alca\data\l159_body_2_co.paa"};
    ...
    class ACR_A3_L39_Albatros_CAS: I_Plane_Fighter_03_CAS_F
    {
        ...
        faction = "ACR";
        _generalMacro = "I_Plane_Fighter_03_CAS_F";
        hiddenSelectionsTextures[] = {"\acr_a3_vehicles\alca\data\l-39_body_acr_green_co.paa","\acr_a3_vehicles\alca\data\l-39_body_1_acr_green_co.paa"};
