...
class CfgPatches
{
        class acr_a3_Sa58
        {
                ...
                weapons[]={"acr_a3_Sa58P",
                           ...
                           "acr_a3_Sa58V_camo",
                           "acr_a3_Sa58RIS1",
                           "acr_a3_Sa58RIS1_camo",
                           "acr_a3_Sa58RIS2",
                           "acr_a3_Sa58RIS2_camo"};
                requiredVersion=0.1;
...
class CfgWeapons
{
        ...
        swayDecaySpeed=1.25;
                ...
                handAnim[] = {"OFP2_ManSkeleton", "acr_a3_weapons\acr_a3_Sa58\Data\Anim\AK.rtm"}; /// MX hand animation actually fits this rifle well
                dexterity = 1.8;
        ...
        class acr_a3_Sa58P: acr_a3_Sa58_base
        {
                ...
                model = "acr_a3_weapons\acr_a3_Sa58\sa58p.p3d"; /// path to model
 
                picture = "acr_a3_weapons\acr_a3_Sa58\Data\UI\sa58p_ca.paa"; /// different accessories have M, S, T instead of X
				...
				hiddenSelectionsTextures[] = {"acr_a3_weapons\acr_a3_sa58\data\sa58_co.paa"};
        };
		...
		class acr_a3_Sa58P_camo: acr_a3_Sa58P
        {
				...
				sections[]={"camo"};
				hiddenSelections[] = {"camo"}; 
				hiddenSelectionsTextures[] = {"acr_a3_weapons\acr_a3_sa58\data\sa58camo_co.paa"};
        };
 
        class acr_a3_Sa58V: acr_a3_Sa58P
        {
                displayName = "vz. 58 V"; /// some name
                model = "acr_a3_weapons\acr_a3_Sa58\sa58V.p3d"; /// path to model
                picture = "acr_a3_weapons\acr_a3_Sa58\Data\UI\sa58v_ca.paa"; /// different accessories have M, S, T instead of X
				sections[]={"camo"};
				hiddenSelections[] = {"camo"}; 
				hiddenSelectionsTextures[] = {"acr_a3_weapons\acr_a3_sa58\data\sa58_co.paa"};
        ...
        class acr_a3_Sa58RIS1: acr_a3_Sa58_base
        {
                ...
                model = "acr_a3_weapons\acr_a3_Sa58\sa58ris.p3d";
 
                handAnim[] = {"OFP2_ManSkeleton", "acr_a3_weapons\acr_a3_Sa58\Data\Anim\Mk48.rtm"}; /// MX hand animation actually fits this rifle well
 
                picture = "acr_a3_weapons\acr_a3_Sa58\Data\UI\sa58ref_ca.paa";
				...
				hiddenSelectionsTextures[] = {"acr_a3_weapons\acr_a3_sa58\data\sa58_co.paa", "acr_a3_weapons\acr_a3_sa58\data\sa58sfcamo1_co.paa"};
        };
		
		class acr_a3_Sa58RIS1_camo: acr_a3_Sa58RIS1
        {
                displayName = "vz. 58 RIS Desert"; /// some name
                picture = "acr_a3_weapons\acr_a3_Sa58\Data\UI\sa58acog_ca.paa"; /// different accessories have M, S, T instead of X
				sections[]={"camo","RIS"};
				hiddenSelections[] = {"camo","RIS"}; 
				hiddenSelectionsTextures[] = {"acr_a3_weapons\acr_a3_sa58\data\sa58camo_co.paa", "acr_a3_weapons\acr_a3_sa58\data\sa58sfcamo_co.paa"};
        };
 
        class acr_a3_Sa58RIS2: acr_a3_Sa58RIS1
        {
                displayName = "vz. 58 RIS2"; /// some name
                model = "acr_a3_weapons\acr_a3_Sa58\sa58ris_back.p3d"; /// path to model
                picture = "acr_a3_weapons\acr_a3_Sa58\Data\UI\sa58acog_ca.paa"; /// different accessories have M, S, T instead of X
				sections[]={"camo","RIS"};
				hiddenSelections[] = {"camo","RIS"}; 
				hiddenSelectionsTextures[] = {"acr_a3_weapons\acr_a3_sa58\data\sa58_co.paa", "acr_a3_weapons\acr_a3_sa58\data\sa58sfcamo1_co.paa"};
